...
export default function Home() {
  ...
  const cutOfTheWeekProduct = cutOfTheWeek ? products.find((p) => p.id === cutOfTheWeek.productId) : null;
  ...
  const cutOfTheWeekImage = cutOfTheWeekProduct ? PlaceHolderImages.find((img) => img.id === cutOfTheWeekProduct.imageId) : null;
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      {cutOfTheWeekProduct && cutOfTheWeek && cutOfTheWeekImage && (
